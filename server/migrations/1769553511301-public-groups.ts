...
export class PublicGroups1769553511301 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "community" ADD "public" boolean NOT NULL DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "community" ADD "maxCapacity" integer`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "community" DROP COLUMN "maxCapacity"`);
