...
export class MemberJoinedCommunityNotifCategory1769625580708 implements MigrationInterface {
    name = 'MemberJoinedCommunityNotifCategory1769625580708'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "community" ALTER COLUMN "maxCapacity" SET DEFAULT '20'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "community" ALTER COLUMN "maxCapacity" SET DEFAULT '15'`);
    }
