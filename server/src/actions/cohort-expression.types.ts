/**
 * Cohort Expression Types
 *
 * A composable boolean expression tree for defining which users
 * should participate in an action. Replaces the old
 * useManualCohort/manualCohortUserIds/participatingTags system.
 */
