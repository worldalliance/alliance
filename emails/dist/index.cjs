...
var require_cjs2 = __commonJS({
  "../node_modules/style-to-js/cjs/index.js"(exports2, module2) {
    "use strict";
    var __importDefault = exports2 && exports2.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
...
__export(index_exports, {
  FormSummaryEmail: () => FormSummaryEmail,
...
var import_juice = __toESM(require("juice"), 1);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
    Markdown,
    {
      components: {
        ...
        strong: ({ ...props }) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("strong", { className: "!font-medium", ...props }),
        p: ({ ...props }) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "text-zinc-800 first:mt-0 mt-2", ...props }),
        ...
        ul: ({ ...props }) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("ul", { className: "text-zinc-800 list-disc list-inside pl-2", ...props }),
        li: ({ ...props }) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("li", { className: "text-zinc-800 my-1", ...props }),
        a: ({ ...props }) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("a", { className: "text-link", ...props })
      },
  ...
  switch (field.kind) {
    case "text":
      return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "space-y-1", children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("label", { className: "block text-gray-700", children: [
          field.label,
          field.required && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "text-red-500 ml-1", children: "*" })
        ] }),
    ...
    case "textarea":
      return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "space-y-1", children: [
        ...
        field.maxLength && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("p", { className: "text-xs text-gray-500 mt-1", children: [
          "Maximum ",
          field.maxLength,
          " characters"
        ] })
    ...
    case "number":
      return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "space-y-1", children: [
        ...
        field.min !== void 0 || field.max !== void 0 ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "text-xs text-gray-500 mt-1", children: field.min !== void 0 && field.max !== void 0 ? `Range: ${field.min} - ${field.max}` : field.min !== void 0 ? `Minimum: ${field.min}` : `Maximum: ${field.max}` }) : null
      ] });
    case "checkbox":
      return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "space-y-1", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("label", { className: "flex items-start", children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
          "input",
          {
            type: "checkbox",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: "text-zinc-700 flex flex-row items-start", children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(FormMarkdownWrapper_default, { markdownContent: field.label }),
          field.required && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "text-red-500 ml-1", children: "*" })
        ] })
      ] }) });
    case "radio":
      return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "space-y-2", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "space-y-2", children: field.options.map((option, optIndex) => /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("label", { className: "flex items-start", children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
            "input",
            {
              type: "radio",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: " text-gray-700", children: option.label })
        ] }, optIndex)) })
      ] });
    case "select":
      return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "space-y-1", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
          "select",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("option", { value: "", className: "placeholder", disabled: true, children: "Select an option" }),
              field.options.map((option, optIndex) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("option", { value: option.value, children: option.label }, optIndex))
            ]
          }
        )
      ] });
    case "multiselect": {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "space-y-2", children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("label", { className: "block text-gray-800", children: [
          field.label,
          field.required && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "text-red-500 ml-1", children: "*" })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "space-y-2", children: field.options.map((option, optIndex) => /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("label", { className: "flex items-center", children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
            "input",
            {
              type: "checkbox",
    ...
    case "file": {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "space-y-2", children: [
        ...
        typeof fileValue === "string" && fileValue && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "mb-2", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
          "img",
          {
            src: fileValue,
            alt: "Uploaded file",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "flex items-center space-x-2", children: [
          ...
          isUploading && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: " text-blue-600", children: "Uploading..." })
        ] }),
        err && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: " text-red-600", children: err })
      ] });
    }
    default:
      return null;
...
function RenderDisplayBlock({ block }) {
  switch (block.kind) {
    ...
    case "text":
      return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "text-zinc-900", children: block.markdown ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "prose prose-sm max-w-none", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(FormMarkdownWrapper_default, { markdownContent: block.text }) }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { className: "whitespace-pre-wrap", children: block.text }) });
    case "label":
      return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "  text-gray-700", children: block.text });
    case "divider":
    ...
    case "html":
      return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { dangerouslySetInnerHTML: { __html: block.html } });
    case "image":
      return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
        "img",
        {
...
function Layout({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("html", { children: [
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("head", { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("meta", { httpEquiv: "x-ua-compatible", content: "ie=edge" }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("body", { children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
      "table",
      {
        role: "presentation",
        width: "100%",
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("tbody", { children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("tr", { children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("td", { children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
          "table",
          {
            role: "presentation",
            width: "100%",
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("tbody", { children: [
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("tr", {}),
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("tr", { children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("td", { className: "section", children }) })
            ] })
          }
        ) }) }) })
      }
...
var FormSummaryEmail = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Layout, { title: `Form: ${schema.title ?? schema.slug}`, children: schema.pages.map((page, pageIdx) => /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("table", { role: "presentation", children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("tbody", { children: page.fields.map((el) => {
    if ("label" in el) {
      return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(RenderField, { field: el });
    } else {
      return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(RenderDisplayBlock, { block: el });
    }
  }) }) }, pageIdx)) });
};
...
function renderEmail(schema) {
  const element2 = import_react3.default.createElement(FormSummaryEmail, { schema });
  const html4 = "<!doctype html>" + (0, import_server.renderToStaticMarkup)(element2);
  const inlined = (0, import_juice.default)(html4);
  const text5 = (0, import_html_to_text.htmlToText)(inlined, { wordwrap: 100 });
