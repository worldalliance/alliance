...
function productionCreate(_, jsx6, jsxs4) {
  return create2;
  function create2(_2, type, props, key) {
    const isStaticChildren = Array.isArray(props.children);
    const fn = isStaticChildren ? jsxs4 : jsx6;
...
// ../shared/ui/FormMarkdownWrapper.tsx
import { jsx as jsx2 } from "react/jsx-runtime";
var FormMarkdownWrapper = ({
  markdownContent
}) => {
  return /* @__PURE__ */ jsx2(
    Markdown,
    {
      components: {
        ...
        strong: ({ ...props }) => /* @__PURE__ */ jsx2("strong", { className: "!font-medium", ...props }),
        p: ({ ...props }) => /* @__PURE__ */ jsx2("p", { className: "text-zinc-800 first:mt-0 mt-2", ...props }),
        ...
        ul: ({ ...props }) => /* @__PURE__ */ jsx2("ul", { className: "text-zinc-800 list-disc list-inside pl-2", ...props }),
        li: ({ ...props }) => /* @__PURE__ */ jsx2("li", { className: "text-zinc-800 my-1", ...props }),
        a: ({ ...props }) => /* @__PURE__ */ jsx2("a", { className: "text-link", ...props })
      },
      children: markdownContent
    }
  );
};
var FormMarkdownWrapper_default = FormMarkdownWrapper;

// ../shared/forms/RenderField.tsx
  ...
  switch (field.kind) {
    case "text":
      return /* @__PURE__ */ jsxs2("div", { className: "space-y-1", children: [
        /* @__PURE__ */ jsxs2("label", { className: "block text-gray-700", children: [
          field.label,
          field.required && /* @__PURE__ */ jsx3("span", { className: "text-red-500 ml-1", children: "*" })
        ] }),
        /* @__PURE__ */ jsx3(
          "input",
          {
    ...
    case "textarea":
      return /* @__PURE__ */ jsxs2("div", { className: "space-y-1", children: [
        ...
        field.maxLength && /* @__PURE__ */ jsxs2("p", { className: "text-xs text-gray-500 mt-1", children: [
          "Maximum ",
          field.maxLength,
          " characters"
        ] })
    ...
    case "number":
      return /* @__PURE__ */ jsxs2("div", { className: "space-y-1", children: [
        ...
        field.min !== void 0 || field.max !== void 0 ? /* @__PURE__ */ jsx3("p", { className: "text-xs text-gray-500 mt-1", children: field.min !== void 0 && field.max !== void 0 ? `Range: ${field.min} - ${field.max}` : field.min !== void 0 ? `Minimum: ${field.min}` : `Maximum: ${field.max}` }) : null
      ] });
    case "checkbox":
      return /* @__PURE__ */ jsx3("div", { className: "space-y-1", children: /* @__PURE__ */ jsxs2("label", { className: "flex items-start", children: [
        /* @__PURE__ */ jsx3(
          "input",
          {
            type: "checkbox",
            checked: !!value,
            onChange: onChange ? (e) => onChange(e.target.checked) : void 0,
            required: field.required,
            disabled,
            className: "mt-1 mr-2 h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
          }
        ),
        /* @__PURE__ */ jsxs2("span", { className: "text-zinc-700 flex flex-row items-start", children: [
          /* @__PURE__ */ jsx3(FormMarkdownWrapper_default, { markdownContent: field.label }),
          field.required && /* @__PURE__ */ jsx3("span", { className: "text-red-500 ml-1", children: "*" })
        ] })
      ] }) });
    case "radio":
      return /* @__PURE__ */ jsxs2("div", { className: "space-y-2", children: [
        ...
        /* @__PURE__ */ jsx3("div", { className: "space-y-2", children: field.options.map((option, optIndex) => /* @__PURE__ */ jsxs2("label", { className: "flex items-start", children: [
          /* @__PURE__ */ jsx3(
            "input",
            {
              type: "radio",
          ...
          /* @__PURE__ */ jsx3("span", { className: " text-gray-700", children: option.label })
        ] }, optIndex)) })
      ] });
    case "select":
      return /* @__PURE__ */ jsxs2("div", { className: "space-y-1", children: [
        ...
        /* @__PURE__ */ jsxs2(
          "select",
          {
            ...
            children: [
              /* @__PURE__ */ jsx3("option", { value: "", className: "placeholder", disabled: true, children: "Select an option" }),
              field.options.map((option, optIndex) => /* @__PURE__ */ jsx3("option", { value: option.value, children: option.label }, optIndex))
            ]
          }
        )
      ] });
    case "multiselect": {
      ...
      return /* @__PURE__ */ jsxs2("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxs2("label", { className: "block text-gray-800", children: [
          field.label,
          field.required && /* @__PURE__ */ jsx3("span", { className: "text-red-500 ml-1", children: "*" })
        ] }),
        /* @__PURE__ */ jsx3("div", { className: "space-y-2", children: field.options.map((option, optIndex) => /* @__PURE__ */ jsxs2("label", { className: "flex items-center", children: [
          /* @__PURE__ */ jsx3(
            "input",
            {
              type: "checkbox",
              ...
              required: !!field.required && selectedCount === 0 && optIndex === 0,
              disabled,
    ...
    case "file": {
      ...
      return /* @__PURE__ */ jsxs2("div", { className: "space-y-2", children: [
        ...
        typeof fileValue === "string" && fileValue && /* @__PURE__ */ jsx3("div", { className: "mb-2", children: /* @__PURE__ */ jsx3(
          "img",
          {
            src: fileValue,
            alt: "Uploaded file",
        ...
        /* @__PURE__ */ jsxs2("div", { className: "flex items-center space-x-2", children: [
          ...
          isUploading && /* @__PURE__ */ jsx3("span", { className: " text-blue-600", children: "Uploading..." })
        ] }),
        err && /* @__PURE__ */ jsx3("p", { className: " text-red-600", children: err })
      ] });
    }
    default:
      return null;
...
// ../shared/forms/RenderDisplayBlock.tsx
  ...
  switch (block.kind) {
    case "header":
      return React.createElement(
        `h${block.level || 2}`,
        {
          className: `font-medium text-zinc-900 ${(block.level || 2) === 1 ? "text-3xl" : (block.level || 2) === 2 ? "text-2xl" : (block.level || 2) === 3 ? "text-xl" : (block.level || 2) === 4 ? "text-lg" : (block.level || 2) === 5 ? "text-base" : ""}`
        },
        block.text
      );
    case "text":
      return /* @__PURE__ */ jsx4("div", { className: "text-zinc-900", children: block.markdown ? /* @__PURE__ */ jsx4("div", { className: "prose prose-sm max-w-none", children: /* @__PURE__ */ jsx4(FormMarkdownWrapper_default, { markdownContent: block.text }) }) : /* @__PURE__ */ jsx4("p", { className: "whitespace-pre-wrap", children: block.text }) });
    case "label":
      return /* @__PURE__ */ jsx4("span", { className: "  text-gray-700", children: block.text });
    case "divider":
      return /* @__PURE__ */ jsx4(
        "hr",
        {
          className: `border-gray-300 ${block.thickness === "hairline" ? "border-t" : block.thickness === "thin" ? "border-t" : block.thickness === "medium" ? "border-t-2" : block.thickness === "thick" ? "border-t-4" : "border-t"}`
        }
      );
    case "spacer":
      return /* @__PURE__ */ jsx4(
        "div",
        {
          className: `${block.size === "xs" ? "h-2" : block.size === "sm" ? "h-4" : block.size === "md" ? "h-8" : block.size === "lg" ? "h-16" : block.size === "xl" ? "h-24" : "h-8"}`
        }
      );
    case "html":
      return /* @__PURE__ */ jsx4("div", { dangerouslySetInnerHTML: { __html: block.html } });
    case "image":
      return /* @__PURE__ */ jsx4(
        "img",
        {
          ...
          style: {
            aspectRatio: block.aspectRatio ? block.aspectRatio.toString() : void 0
          }
        }
      );
    default:
...
function Layout({
  ...
  return /* @__PURE__ */ jsxs3("html", { children: [
    /* @__PURE__ */ jsxs3("head", { children: [
      ...
      /* @__PURE__ */ jsx5("meta", { httpEquiv: "x-ua-compatible", content: "ie=edge" }),
    ...
    /* @__PURE__ */ jsx5("body", { children: /* @__PURE__ */ jsx5(
      "table",
      {
        role: "presentation",
        width: "100%",
        ...
        children: /* @__PURE__ */ jsx5("tbody", { children: /* @__PURE__ */ jsx5("tr", { children: /* @__PURE__ */ jsx5("td", { children: /* @__PURE__ */ jsx5(
          "table",
          {
            role: "presentation",
            width: "100%",
            ...
            children: /* @__PURE__ */ jsxs3("tbody", { children: [
              /* @__PURE__ */ jsx5("tr", {}),
              /* @__PURE__ */ jsx5("tr", { children: /* @__PURE__ */ jsx5("td", { className: "section", children }) })
            ] })
          }
        ) }) }) })
      }
...
var FormSummaryEmail = ({
  schema
}) => {
  return /* @__PURE__ */ jsx5(Layout, { title: `Form: ${schema.title ?? schema.slug}`, children: schema.pages.map((page, pageIdx) => /* @__PURE__ */ jsx5("table", { role: "presentation", children: /* @__PURE__ */ jsx5("tbody", { children: page.fields.map((el) => {
    if ("label" in el) {
      return /* @__PURE__ */ jsx5(RenderField, { field: el });
    } else {
      return /* @__PURE__ */ jsx5(RenderDisplayBlock, { block: el });
    }
  }) }) }, pageIdx)) });
};

// src/render.ts
function renderEmail(schema) {
  const element2 = React2.createElement(FormSummaryEmail, { schema });
  const html4 = "<!doctype html>" + renderToStaticMarkup(element2);
  const inlined = juice(html4);
  const text5 = htmlToText(inlined, { wordwrap: 100 });
  return { html: inlined, text: text5 };
}
export {
  FormSummaryEmail,
  renderEmail
