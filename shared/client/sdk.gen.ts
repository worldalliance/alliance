 ...
 */
export const userSavePushToken = <ThrowOnError extends boolean = false>(options: Options<UserSavePushTokenData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<unknown, unknown, ThrowOnError>({
        url: '/user/pushToken',
        ...options,
        headers: {
 ...
 */
export const userRemovePushToken = <ThrowOnError extends boolean = false>(options: Options<UserRemovePushTokenData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<unknown, unknown, ThrowOnError>({
