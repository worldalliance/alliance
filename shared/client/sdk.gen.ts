...
export const userHi = <ThrowOnError extends boolean = false>(options?: Options<UserHiData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<unknown, unknown, ThrowOnError>({
        url: '/user/hi',
        ...options
    });
