...
import type { AppHealthCheckData, AuthLoginData, AuthLoginResponse, AuthAdminLoginData, AuthAdminLoginResponse, AuthRegisterData, AuthRefreshTokensData, AuthRefreshTokensResponse, AuthMeData, AuthMeResponse, ActionsCreateData, ActionsCreateResponse, ActionsJoinData, ActionsMyStatusData, ActionsMyStatusResponse, ActionsFindAllData, ActionsFindAllResponse, ActionsRemoveData, ActionsFindOneData, ActionsFindOneResponse, ActionsUpdateData, CommuniquesFindAllData, CommuniquesFindAllResponse, CommuniquesCreateData, CommuniquesCreateResponse, CommuniquesRemoveData, CommuniquesRemoveResponse, CommuniquesFindOneData, CommuniquesFindOneResponse, CommuniquesUpdateData, CommuniquesUpdateResponse, CommuniquesGetReadData, CommuniquesGetReadResponse, CommuniquesReadData, ImagesUploadImageData, ImagesUploadImageResponse, ImagesGetImageData, ImagesGetImageResponse, ImagesDeleteImageData, ImagesDeleteImageResponse, ForumFindAllPostsData, ForumFindAllPostsResponse, ForumCreatePostData, ForumCreatePostResponse, ForumFindPostsByActionData, ForumFindPostsByActionResponse, ForumRemovePostData, ForumRemovePostResponse, ForumFindOnePostData, ForumFindOnePostResponse, ForumUpdatePostData, ForumUpdatePostResponse, ForumCreateReplyData, ForumCreateReplyResponse, ForumRemoveReplyData, ForumRemoveReplyResponse, ForumUpdateReplyData, ForumUpdateReplyResponse } from './types.gen';
...
export const forumRemovePost = <ThrowOnError extends boolean = false>(options: Options<ForumRemovePostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<ForumRemovePostResponse, unknown, ThrowOnError>({
        url: '/forum/posts/{id}',
        ...options
    });
};
...
export const forumRemoveReply = <ThrowOnError extends boolean = false>(options: Options<ForumRemoveReplyData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<ForumRemoveReplyResponse, unknown, ThrowOnError>({
