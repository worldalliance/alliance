/**
 * The long-form public pages, as markdown. Copy is the copy the site already
 * served; only its setting has changed.
 */
...
These crises represent egregious violations of our foundational [moral principle](/foundation): that we should not treat others in ways that we do not want to be treated. They cause, or have the potential to cause, enormous harm to billions of people.
...
Our [foundation](/foundation) explains how we derived them.
`,
  },
  {
...
Our [governance](/governance) page sets out the procedures in full.
`,
  },
  {
...
`,
  },
  {
    ...
    answer: `
Right now, we are taking small-scale actions focused on learning, not direct impact. Our [progress](/progress) page lists what we have done so far.
`,
  },
  {
...
`,
  },
  {
    ...
    answer: `
The Alliance is run by Sidney Hough and Mark Xu. The full list of Alliance staff is on our [people](/people) page.
`,
  },
  {
...
- Personal information collected for Messaging Services will be handled in accordance with our [privacy policy](/privacypolicy).
