...
function ContractDescriptionList({
  ...
  return (
    <div className="bg-white p-5 sm:p-6 border border-zinc-200 flex flex-col gap-y-5">
  ...
  return (
    <CenterLayout>
      <div className="gap-y-8 flex flex-col text-base md:text-lg">
                ...
                lastContractEvent.contractId === latestContract.id ? (
                  ...
                  <div className="flex flex-col gap-y-4 border-zinc-200 border-t pt-5">
                    ...
                    <div className="flex flex-col gap-y-2">
                      <p className="rounded border border-l-4 border-zinc-200 border-l-green bg-zinc-50 px-4 py-3 text-[16px] italic text-zinc-800">
        ...
        <section className="flex flex-col gap-y-5 my-4">
          <div className="flex flex-col gap-y-2">
            <h2 className="text-xl md:text-2xl font-semibold text-black">
          ...
          <div className="flex flex-col gap-y-1">
            ...
            <ol className="list-decimal list-outside pl-4 space-y-1">
              <li className="text-base">
                You can withdraw from an action by tapping the three dots at the
                bottom right of an action, next to the Complete button. You can
                withdraw if the action is taking you longer than 15 minutes to
                complete, or if you have a moral objection to the action.
              </li>
              <li className="text-base">
                You can mark yourself as away in Settings if you won&apos;t be
                able to complete actions for a prolonged period, such as during
                a vacation.
              </li>
            </ol>
          </div>
