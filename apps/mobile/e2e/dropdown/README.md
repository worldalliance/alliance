...
This isolated Expo fixture imports the real picker and uses 40 synthetic options. It makes no API calls. Run it with an installed Alliance development client, an unlocked Android device, and Maestro.
