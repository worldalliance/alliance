...
/** The agreement and the welcome tie: one step, two screens. */
...
export const STEP_TONE: Record<OnboardingStep, PanelTone> = {
  [OnboardingStep.Account]: PanelTone.Photo,
...
export const ACCOUNT_HEADING: Record<AccountMode, string> = {
  [AccountMode.SignUp]: "Create your account",
  [AccountMode.LogIn]: "Log in",
};
