...
const TodoCard: React.FC<TodoCardProps> = ({
  ...
  return (
    <div className="flex items-center justify-between p-5 rounded-lg bg-white shadow-[0_0_10px_0_rgba(0,0,0,0.03)] border border-gray-200 mb-2.5 w-[500px]">
      ...
      <div>
        <div className="flex items-center justify-between pb-2.5 pl-2.5">
          ...
          <div className="bg-[#333] px-1.5 py-0.75 rounded flex items-center justify-center">
            <p className="text-[10pt] font-semibold mt-[5px] text-white">
              {category}
            </p>
          </div>
        </div>
