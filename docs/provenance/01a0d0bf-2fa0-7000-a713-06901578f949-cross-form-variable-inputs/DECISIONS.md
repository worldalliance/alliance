...
- **Stale responses:** loaded histories are keyed by subject and source ids. A response for an earlier key is dropped, and history does not refetch while the key stays the same.
