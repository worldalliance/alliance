...
- Context from the agent: on web, "Complete (Preview Mode)" validated only the current page, while mobile validated every page. The user's answer: "let's have them both validate all pages".
