---
user: Charles Lien
task: Remote PR screenshots
---

- Run pr-screenshots remotely using one provider. GitHub Actions and AWS were suggested as possibilities.
- Account for the security risk of running agents against an open-source repository.
